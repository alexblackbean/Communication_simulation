...
class Ui_Form(object):
    ...
    def object_initialize(self, Form):
        ...
        self.debug_terminal.setStyleSheet("background-color: rgba(255, 255 , 255, 100%)")
        ...
        self.fps.setGeometry(QtCore.QRect(self.text_base_x, self.text_base_y, 150, 45))
        ...
        self.way.setGeometry(QtCore.QRect(self.text_base_x, self.text_base_y + 50, 150, 45))

        self.label_car = QtWidgets.QLabel(self.control_panel)
        self.label_car.setFont(self.font)
        self.label_car.setGeometry(QtCore.QRect(self.text_base_x + 180, self.text_base_y, 480, 30))
    ...
    def retranslateUi(self, Form):
        ...
        # self.label.setText(_translate("Form", "<html><head/><body><p><img src=\"grid_500.png\"/></p></body></html>"))
    ...
    #             x = self.entry[i][0]*scale_map+offset #plot coordinate x, self.entry is real initial position
    ...
    #         if item[5] == 5:
    #             item[5] = 0
    #             item[0].setGeometry(QtCore.QRect(x+x_speed*5*scale, y+y_speed*5*scale, 10, 10))
    ...
    #         base.setGeometry(QtCore.QRect(item[2]*20, item[3]*20, 10, 10)) # 20 is scale of the map, 20 = 50 (a block of map) // 2.5(real world block distance)
    #         base.setObjectName("base")
    #         base.setPixmap(QPixmap('base_img.png'))
    #         base.show()
    #     return position
